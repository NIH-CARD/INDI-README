...
function [nuclearmask,cytomask,dilatedmask,neuritemask,backgroundmask,objectmask] = multichannelmask_v3(image,nuclearchannel,nucleusminradius,cytoplasmchannel)

[nucleararray, nuclearmask, nuclearnumber, nuclearbinarymask, estimatedmissednuclei, meannucleisize, multinucleicenters] = object_mask_hist_v3(image(:,:,nuclearchannel),nucleusminradius,5); %could be optimized a bit, but is a reasonable start
membranemask = histmask_v3(image(:,:,cytoplasmchannel),2);% calculates mask using histmask_v3, 1 stdevs
[objectmask, dilatedmask] = label_dilatecut_v1(nuclearmask,membranemask,50);
