...
function [objectarray, objectmask, objectnumber, binarymask, estimatedmissedcells, meansize, multiobjectcenters] = object_mask_hist_v3(channel_matrix,minimumradius,stdevs)
