---
title: "hiPSCi cell line evaluation (hNGN2) - 04 Doublet detection"
...
plot_grid(plotlist = c(subcluster_plots, subcluster_doublet_plots), ncol=4)
```
...
sce_object_mnn = correctExperiments(merged_sce_object, 
                                    ...
                                    PARAM=FastMnnParam(
                                      merge.order=list(
                                        as.list(intersect(list("Sample_Combined1_hNGN2", "Sample_Combined2_hNGN2"), merged_sce_object$Sample)),
                                        as.list(intersect(list("Sample_Pool1_hNGN2", "Sample_Pool2_hNGN2"), merged_sce_object$Sample))
                                      )
                                    ))
```
...
merged_subclusters = quickSubCluster(merged_sce_object, groups = merged_clusters, 
                                       prepFUN = function(x) {
                                         ...
                                         input = correctExperiments(x, 
                                                                    ...
                                                                    PARAM=FastMnnParam(
                                                                      merge.order=list(
                                                                        as.list(intersect(list("Sample_Combined1_hNGN2", "Sample_Combined2_hNGN2"), x$Sample)),
                                                                        as.list(intersect(list("Sample_Pool1_hNGN2", "Sample_Pool2_hNGN2"), x$Sample))
                                                                      )
                                                                    ))
                                       }, 
                                       clusterFUN = function(x) {
