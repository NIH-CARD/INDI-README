---
title: "hiPSCi cell line evaluation (hNGN2) - 02 Quality Control Analysis"
...
For the hNIL differentiation, we see a double hump, though the ribo content is still low (?) in the higher hump. In some cell line, it can be seen that the cell line grown together (combined) vs those not grown together (pooled) has different ribosomal pattern?
...
Cells with lowed UMI counts generally have lower ribosomal content and vice versa. For the double hump that we see, it doesn't seem like it can be explained by the UMI content.
...
We do not identify any outlier for ribosomal.
