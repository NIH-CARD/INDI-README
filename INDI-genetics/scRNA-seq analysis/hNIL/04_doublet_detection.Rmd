---
title: "hiPSCi cell line evaluation (hNIL) - 04 Doublet detection"
...
sce_object_mnn = correctExperiments(merged_sce_object, 
                                    ...
                                    PARAM=FastMnnParam(
                                      merge.order=list(
                                        as.list(intersect(list("Sample_Combined1_hNIL", "Sample_Combined2_hNIL"), merged_sce_object$Sample)),
                                        as.list(intersect(list("Sample_Pool1_hNIL", "Sample_Pool2_hNIL"), merged_sce_object$Sample))
                                      )
                                    ))
```
...
merged_subclusters = quickSubCluster(merged_sce_object, groups = merged_clusters, 
                                       prepFUN = function(x) {
                                         ...
                                         input = correctExperiments(x, 
                                                                    ...
                                                                    PARAM=FastMnnParam(
                                                                      merge.order=list(
                                                                        as.list(intersect(list("Sample_Combined1_hNIL", "Sample_Combined2_hNIL"), x$Sample)),
                                                                        as.list(intersect(list("Sample_Pool1_hNIL", "Sample_Pool2_hNIL"), x$Sample))
                                                                      )
                                                                    ))
                                       }, 
                                       clusterFUN = function(x) {
