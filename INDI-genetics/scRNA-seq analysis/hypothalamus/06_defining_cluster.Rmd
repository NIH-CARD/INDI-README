---
title: "hiPSCi cell line evaluation (hypothalamus) - 08 Defining cluster"
...
```{r}
cell_lines = c("KOLF2-ARID2-A02", "KUCG3-C1", "LNGPI1-C1","NCRM1-C6","NCRM5-C5","NN0003932-C3","PGP1-C2")
sce_object_mnn$vireo_assignment = factor(sce_object_mnn$vireo_assignment, levels=cell_lines)
...
contributions$`Cell line` = factor(contributions$`Cell line`, levels=cell_lines)
