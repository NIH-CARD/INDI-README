---
title: "hiPSCi cell line evaluation (hypothalamic) - 01 Cell Calling"
...
lapply(sce_object, function(x){
  mat = assay(x)
  targets = mat[, Matrix::colSums(mat)!=0 & Matrix::colSums(mat) < 500]
...
So we will need to use a much higher threshold due to the high sequencing depth of these samples. 400 looks like a good threshold as it is after the peak.
