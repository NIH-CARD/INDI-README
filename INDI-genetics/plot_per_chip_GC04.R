...
# prep input file
data = read.table("anno_file_neurochip_GC_filter04.txt",header=T)
...
snp.annotation <- read.table("anno_file_neurochip_GC_filter04.txt",header=T)
# name for gds file1
...
pdf(paste(FILENAME,"_GC04.pdf",sep=""))
